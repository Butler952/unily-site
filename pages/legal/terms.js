...
const Terms = () => {
  ...
  return (
    <LegalPage
      ...
      lastUpdated="17th Mar 2025"
    >
      <div className="my-4 my-sm-5" >
        <div className="Group">
          <h3>1.   Agreement to Terms</h3>
          <br></br>
          <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and epicbabynames.com (we, us), concerning your access to and use of the epicbabynames.com (https://www.epicbabynames.com) website as well as any related applications (the Site).</p>
          <p>The Site provides the following services: <strong>To promote epicbabynames.com and allow users to find curated collections of names from various literary works, including but not limited to classical literature</strong>. You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
      ...
      <div className="my-4 my-sm-5">
        <div className="Group">
          ...
          <p>8.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at team@epicbabynames.com</p>
        </div>
      </div>
    </LegalPage>
  )
