    ...
    >
      <div className="m-4 m-sm-5" >
        <div className="Group">
          ...
          <br></br>
          <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and expertpage.io (we, us), concerning your access to and use of the expertpage.io (https://www.expertpage.io) website as well as any related applications (the Site).</p>
          <p>The Site provides the following services: <strong>To promote expertpage.io and allow users to create their personal landing page</strong>. You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
      ...
      <div className="m-4 m-sm-5">
        <div className="Group">
          ...
          <p>8.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at aaron@expertpage.io</p>
        </div>
      </div>
    </LegalPage>
  )
