    ...
    >
      ...
      <div className="m-4 m-sm-5">
        <div className="Group">
          ...
          <p>8.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at aaron@vitaely.me</p>
        </div>
      </div>
    </LegalPage>
  )
