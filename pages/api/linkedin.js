...
export default async function handler(req, res) {
 ...
 var myHeaders = new Headers();
  ...
  myHeaders.append("Access-Control-Allow-Origin", "https://www.expertpage.io, https://expertpage.vercel.app, http://localhost:3000/, https://localhost:3000/, https://nubela.co/proxycurl/api/v2/, https://firebasestorage.googleapis.com");
  ...
  var strippedUrl = req.query.profileUrl.split("/in/").pop()
