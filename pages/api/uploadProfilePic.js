...
export default async function handler(req, res) {
 ...
 var myHeaders = new Headers();
  ...
  myHeaders.append("Access-Control-Allow-Origin", "https://www.vitaely.me, https://vitaely.vercel.app, firebasestorage.googleapis.com/, http://localhost:3000/, https://localhost:3000/, https://nubela.co/proxycurl/api/v2/");
