  ...
  return (
    <div>
      <Post 
        ...
        readingDuration="2"
        hideFooter
        description="You’ve created your profile with vitaely.me and you’ve now got a beautiful personal landing page with all your information. Now what? We’re happy to share that you can now download your profile as a PDF!"
      ...
      >
        ...
        <div className="py-4 background-light">
          <p className="large">You’ve created your profile with vitaely.me (if not you can <Link href="/users/register">get started here</Link>) and you’ve now got a beautiful personal landing page with all your information. Now what?</p>
        ...
        <div className="py-4 background-light">
          ...
          <div className={`${styles.heroImageWrapper} mt-5`}>
            <Image alt="Download resume section in the settings page" src='/images/blog/how-to-download-your-resume-as-a-pdf/vitaely-download-resume-section.jpg' layout="fill" objectFit="cover" />
          </div>
