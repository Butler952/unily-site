  ...
  return (
    <div>
      <Post 
        ...
        imageAlt="A short guide on how to update the URL of your expertpage.io profile."
        readingDuration="2"
        hideFooter
        description="A short guide on how to update the URL of your expertpage.io profile."
      ...
      >
        ...
        <div id="the-standard-format" className="py-4 background-light">
          ...
          <p className="large">When you create your ExpertPage profile, we will automatically create a URL for your profile. As an example, this will be something like: <i>expertpage.io/profile/4K6y8GFtKAbn6r34EtRM2bnQQpq2</i>.</p>
        ...
        <div id="why-change-it" className="py-4 background-light">
          ...
          <p className="large">To make your profile feel more your own, you can now create a custom URL on the first-level directory of expertpage.io.</p>
          <p className="large">As an example, this could be something like: <i>expertpage.io/aaronbutler</i>.</p>
        ...
        <div id="how-do-i-change-my-profile-url" className="py-4 background-light">
          ...
          {/* <p className="large">You can choose between <b>Standard</b> where your URL will include a random string in the <i>/profile</i> directory (e.g. <i>expertpage.io/profile/4K6y8GFtKAbn6r34EtRM2bnQQpq2</i>) and <b>Personalised</b> where you can choose a handle of your choosing in the expertpage.io base directory (e.g. <i>expertpage.io/aaronbutler</i>).</p> */}
          <div className={`${styles.featureCard} my-5`}>
            <img alt="Manage your expertpage.io plan" src='../../images/blog/how-to-change-your-profile-url/choose-your-profile-handle-onboarding.jpg'></img>
          </div>
          ...
          <div className={`${styles.featureCard} my-5`}>
            <img alt="Manage your expertpage.io plan" src='../../images/blog/how-to-change-your-profile-url/choose-your-profile-handle-settings.jpg'></img>
          </div>
        ...
        <div id="how-to-upgrade" className="py-4 background-light">
          ...
          <p className="large">To upgrade your plan, log into ExpertPage and go to the settings page of your expertpage.io account.</p>
