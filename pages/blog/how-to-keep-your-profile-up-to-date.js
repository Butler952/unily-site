  ...
  return (
    <div>
      <Post 
        ...
        imageAlt="A short guide on how to keep your expertpage.io profile up to date."
        readingDuration="2"
        hideFooter
        description="A short guide on how to keep your expertpage.io profile up to date."
      ...
      >
        ...
        <div id="how-to-keep-your-profile-to-date" className="py-4 background-light">
          ...
          <p className="large">To keep your expertpage.io profile up to date with your LinkedIn profile, you can use the Resync feature. When you trigger a resync, we update your profile with the latest information on your LinkedIn profile. </p>
          <p className="large">Make sure that your LinkedIn profile's <Link href="https://www.linkedin.com/public-profile/settings">public visibility settings</Link> include all the data that you want to sync into ExpertPage.</p>
