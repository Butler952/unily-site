    ...
    <div>
      ...
      >
        <div id="content" className="py-4 background-light">
          ...
          <li><p className="large mb-2"><a href="#vitaely">Vitaely.me</a></p></li>
        ...
        <div id="vitaely" className="py-4 background-light">
          <Link href="/"><h3>Vitaely.me</h3></Link>
          ...
          <div className={`${styles.heroImageWrapper} my-5`}>
            <Image alt="Vitaely.me online resume builder" src='/images/blog/cv-resume-builder-alternatives/vitaely-landing-page.jpeg' layout="fill" objectFit="cover" />
          </div>
          <p className="large">With Vitaely.me, there's no need to enter all of your work history and education again. To create your profile, all you have to do is paste the URL for your Linkedin profile and Vitaely.me will instantly generate an online resume.</p>
          ...
          <div className={`${styles.heroImageWrapper} my-5`}>
            <Image alt="Vitaely.me online resume" src='/images/blog/cv-resume-builder-alternatives/vitaely-profile.jpeg' layout="fill" objectFit="cover" />
          </div>
          ...
          <p className="large"><Link href="/users/register">Click here</Link> to create your online resume in two minutes with Vitaely.me.</p>
        </div>
