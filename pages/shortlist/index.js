                  ...
                  <Dropdown align="end">
                    ...
                    <Dropdown.Menu as={CustomMenu} align="end" className="mt-2">
                      <div className="p-2">
                        {screenWidth > 575 ? (
                          <div
                            className={`${styles.shareGrid} w-100 p-3`}
                          ...
                          >
                            <div className="d-flex flex-column align-items-center gap-2">
                              <button
                                ...
                                className="btn light medium small icon-only"
                              ...
                              <p className="text-dark-high small font-weight-medium mb-0">
                                Share
                              </p>
                            </div>
                            <div className="d-flex flex-column align-items-center gap-2">
                          ...
                          >
                            <button
                              ...
                              className="btn light medium x-small icon-left w-100"
                              disabled={sharingName}
                            >
                              <svg viewBox="0 0 24 24">
                                <path d={ICONS.SHARE}></path>
                            ...
                            <a
                              ...
                              className="btn primary medium x-small icon-left w-100"
                            ...
                            <a
                              ...
                              className="btn primary high x-small icon-left w-100"
                        ...
                        >
                          <div className="d-flex flex-row align-items-start justify-content-between">
                            <div>
                              ...
                              <p className="mb-0">
                                Create an account to avoid forgetting these
                                names and being forced to name your child Steve
                                or Blue Ivy.
                              </p>
                            </div>
                          </div>
