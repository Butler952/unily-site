  ...
  return (
    ...
    >
      <div className="d-flex flex-column align-items-start ">
        ...
        <h6 className="text-dark-low">
          After gathering date and looking at existing data with this existing
        ...
        <h6 className="text-dark-low mb-0">
          <ul>
            <li>Social garage</li>
            <li>Co-subscription</li>
            <li>
              Co-ownership (Proved to be too complicated and didn't want to get
              into being a creditor)
            </li>
            <li>
              Community sharing (Parked for now as social garage seen as a way
              of validating this)
            </li>
          </ul>
        </h6>
        <h6 className="text-dark-low"></h6>
      </div>
