...
import profileStyles from './MetroProfile.module.scss'
...
const MetroProfile = (props) => {
  ...
  const getSummaryText = () => {
    ...
    if (props.summary.length <= 258) return (
      <p className={`mb-0 ` + styles.summary}>
        {props.summary}
      </p>
    );
  ...
  const getDescriptionText = (description, descriptionShowMore, setDescriptionShowMore) => {
    ...
    if (description.length <= 258) return (
      <p className="text-dark-low mb-0 mt-3">
        {description}
      </p>
    );
    // If text is longer than desired length & showMore is true
              ...
              <div className="">
                <div className="px-0 px-md-5">
                  ...
                  {(props.side_projects && props.side_projects.length > 0) &&
                    <div className="mb-5 py-3">
                      <h4 className="font-weight-medium">Side projects</h4>
                      <div className="">
                                  ...
                                  <div className={`${profileStyles.jobContent}`}>
                                    <div className="">
                                      <a target="_blank" href={sideProject.url && convertToLink(sideProject.url)} className={`${profileStyles.link}`}>
                                        <p className="text-dark-high font-weight-medium mb-0">{sideProject.name}</p>
                                        {/* <svg width="24" viewBox="0 0 24 24">
                                          <path d={ICONS.ARROW_LINK}></path>
                                        </svg> */}
                                      </a>
                                      {/* <p className="large text-dark-low mb-0">{sideProject.tagline}</p> */}
                                      <p className="text-dark-low mb-0">{sideProject.tagline}</p>
                                    </div>
                                    <p className="text-dark-low mb-0 text-md-right" style={{ whiteSpace: 'nowrap' }}>
                  ...
                  {(props.experiences && props.experiences.length > 0) &&
                    <div className="mb-5 py-3">
                      <h4  className="font-weight-medium">Experience</h4>
                      <div className="">
                                  ...
                                  <div className={`${profileStyles.jobContent}`}>
                                    <div className="">
                                      <a target="_blank" href={job.company_linkedin_profile_url && convertToLink(job.company_linkedin_profile_url)} className={`${profileStyles.link}`}>
                                        <p className="text-dark-high font-weight-medium mb-0">{job.company}</p>
                                        {/* <svg width="24" viewBox="0 0 24 24">
                                          <path d={ICONS.ARROW_LINK}></path>
                                        </svg> */}
                                      </a>
                                      {/* <p className="large text-dark-low mb-0">{sideProject.tagline}</p> */}
                                      <p className="text-dark-low mb-0">{job.title}</p>
                                    </div>
                  ...
                  {(props.projects && props.projects.length > 0) &&
                    <div className="mb-5 py-3">
                      <h4  className="font-weight-medium">Projects</h4>
                                ...
                                <Accordion className={`d-flex flex-column align-items-start`}>
                                  ...
                                  <div className="w-100">
                                    <a target="_blank" href={convertToLink(project.url)}>
                                      <p className="text-dark-high font-weight-medium mb-0">{project.name}</p>
                                    </a>
                                    <p className="text-dark-low mb-0">
                  ...
                  {(props.education && props.education.length > 0) &&
                    <div className="mb-5 py-4">
                      <h4  className="font-weight-medium">Education</h4>
                      <div className="">
                              ...
                              <div className="d-flex flex-column flex-lg-row">
                                ...
                                {props.logoVisibility && props.logoVisibility.education ?
                                  (school.logo_url ?
                                    ...
                                    :
                                    <div className="bg-dark-20{0 radius-3 d-flex align-items-center justify-content-center mb-3 mb-lg-0 mr-0 mr-lg-4" style={{ width: '72px', height: '72px', minWidth: '72px', minHeight: '72px' }}>
                                      <Icon icon={ICONS.SCHOOL} size='32' className="fill-dark-700" />
                                    </div>
                                  ) : null}
                                  ...
                                  <div className={`${profileStyles.jobContent}`}>
                                    <div className="">
                                      <a target="_blank" href={school.school_linkedin_profile_url && convertToLink(school.school_linkedin_profile_url)} className={`${profileStyles.link}`}>
                                        <p className="text-dark-high font-weight-medium mb-0">{school.school}</p>
                                        {/* <svg width="24" viewBox="0 0 24 24">
                                          <path d={ICONS.ARROW_LINK}></path>
                                        </svg> */}
                                      </a>
                  ...
                  {(props.volunteer_work && props.volunteer_work.length > 0) &&
                    <div className="mb-5 py-3">
                      <h4  className="font-weight-medium">Volunteering</h4>
                      <div className="">
                                  ...
                                  <div className={`${profileStyles.jobContent}`}>
                                    <div className="">
                                      <a target="_blank" href={volunteer.company_linkedin_profile_url && convertToLink(volunteer.company_linkedin_profile_url)} className={`${profileStyles.link}`}>
                                        <p className="text-dark-high font-weight-medium mb-0">{volunteer.company}</p>
                                        {/* <svg width="24" viewBox="0 0 24 24">
                                          <path d={ICONS.ARROW_LINK}></path>
                                        </svg> */}
                                      </a>
                                      {/* <p className="large text-dark-low mb-0">{sideProject.tagline}</p> */}
                                      <p className="text-dark-low mb-0">{volunteer.title}</p>
                                    </div>
                                    <div className="text-md-right">
                                      <p className="text-dark-low mb-0">
