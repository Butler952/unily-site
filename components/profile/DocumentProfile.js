...
import profileStyles from './DocumentProfile.module.scss'
      ...
      {props.email !== undefined ?
        <div>
          ...
          <div>
            ...
            <Container className="py-5 px-3 px-md-3" style={{maxWidth: '960px'}}>
                ...
                <div className="px-0 px-md-5">
                  <div className="mt-0 mt-md-5 mb-5 py-3">
                    ...
                    <div className="mb-5 d-flex flex-column ">
                      ...
                      {props.headline &&
                        <h5 className="font-weight-medium text-dark-med mb-0" style={{ maxWidth: '640px' }}>{props.headline}</h5>
                      }
                    </div>
                    {/* {props &&
                      props.displayInfo &&
                    ...
                    {/* {(props.linksPrimary || props.email || links) &&
                      <div className="d-flex flex-column" style={{ gap: '12px' }}>
                        {props.linksPrimary ?
                          <a href={convertToLink(props.linksPrimary.url)} target="_blank" className={`${profileStyles.link}`}>
                                          ...
                                          <div className="d-flex flex-column w-100" style={{ gap: '16px' }}>
                                            <div className="w-100 position-relative" style={{paddingTop: '56.25%'}}>
                                              <img
                                                ...
                                                style={{ top: 0, left: 0, zIndex: 1, objectFit:'cover' }}
                                              />
