      ...
      {props.email !== undefined ?
        <>
          ...
          <div style={{ marginTop: '66px' }}>
            ...
            <Container>
              <div className={`${styles.profileCard} card p-5`}>
                <div className="my-5">
                  ...
                  {props &&
                    ...
                    props.displayInfo.basicInfo.each.email
                    || props.links ?
                    <div className="d-flex align-items-center flex-column flex-md-row" style={{ gap: '12px' }}>
                      {props.email && props.displayInfo.basicInfo.each.email &&
                      <a href={'mailto:' + props.email} target="_blank" className="btn dark medium small icon-right">
                        <svg viewBox="0 0 24 24">
                      ...
                      {props.links &&
                        props.links.map((link, index) => {
                          return (
                            <a key={index} href={link.url} target="_blank" className="btn dark low small icon-right">
                              <svg viewBox="0 0 24 24">
                                <path d={ICONS.ARROW_LINK}></path>
                              </svg>
                              {link.label}
